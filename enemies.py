...
class FairyType2(EnemyType2):
    sprites = [
            pygame.image.load("fairies/fairy2_0.png"), 
            pygame.image.load("fairies/fairy2_1.png"), 
            pygame.image.load("fairies/fairy2_2.png"), 
            pygame.image.load("fairies/fairy2_3.png")
            ]

    sprites_turn =  [
            pygame.image.load("fairies/turn2_0.png"), 
            pygame.image.load("fairies/turn2_1.png"), 
            pygame.image.load("fairies/turn2_2.png"), 
            pygame.image.load("fairies/turn2_3.png")
            ]
    def __init__(self, screen_width, screen_height):
        super().__init__(screen_width, screen_height, self.sprites[0])
...
class FairyType3(EnemyType2):
    sprites = [
            pygame.image.load("fairies/fairy3_0.png"), 
            pygame.image.load("fairies/fairy3_1.png"), 
            pygame.image.load("fairies/fairy3_2.png"), 
            pygame.image.load("fairies/fairy3_3.png")
            ]

    sprites_turn =  [
            pygame.image.load("fairies/turn3_0.png"), 
            pygame.image.load("fairies/turn3_1.png"), 
            pygame.image.load("fairies/turn3_2.png"), 
            pygame.image.load("fairies/turn3_3.png")
            ]
    def __init__(self, screen_width, screen_height):
        super().__init__(screen_width, screen_height, self.sprites[0])
...
class FairyType5(EnemyType1):
    sprites = [
            pygame.image.load("fairies/fairy5_0.png"), 
            pygame.image.load("fairies/fairy5_1.png"), 
            pygame.image.load("fairies/fairy5_2.png"), 
            pygame.image.load("fairies/fairy5_3.png")
            ]
    def __init__(self, screen_width, screen_height):
        super().__init__(screen_width, screen_height, self.sprites[0])
